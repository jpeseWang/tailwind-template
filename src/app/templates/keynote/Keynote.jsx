        ...
        <div class="sm:pt-2 md:pr-6 lg:relative lg:ml-auto lg:w-[19.5rem] lg:flex-none lg:pl-8 lg:pr-0">
          <div class="flex items-center gap-2">
            <h2 class="text-base font-semibold text-slate-900">
              <a href="https://keynote.tailwindui.com">
                <span class="absolute inset-0 lg:left-8"></span>Keynote
              </a>
            </h2>
          </div>
          ...
          <p class="mt-3 text-sm leading-6 text-slate-600">
            Launch your next conference with a splash with this eye-catching
            template.
          </p>
          <div class="mt-4 h-px w-6 bg-slate-300"></div>
          <a
            href="https://github.com/jpeseWang/tailwind-template/raw/main/src/assets/templates/keynote.zip"
            download
        ...
        <div className="lg:relative lg:mr-auto lg:flex lg:min-w-0 lg:overflow-x-auto">
          ...
          <div className="lg:relative lg:flex lg:flex-none lg:items-start lg:pr-8">
            <a
              ...
              href="https://keynote.tailwindui.com"
            >
              <span class="sr-only">View Keynote template</span>
            </a>
            <Image
              src="https://tailwindui.com/img/templates/keynote/preview-01.png"
            ...
            ></Image>
            <Image
              src="https://tailwindui.com/img/templates/keynote/preview-02.png"
              alt="This is a preview image"
              width="560"
              height="380"
            ...
            ></Image>
            <Image
              src="https://tailwindui.com/img/templates/keynote/preview-03.png"
              alt="This is a preview image"
              width="560"
              height="380"
              class="w-full rounded-xl bg-slate-100 lg:w-[19.1666666rem] lg:flex-none lg:ml-8 hidden lg:block"
