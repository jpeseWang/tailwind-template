...
import pic1 from "@/assets/templates/images/NikePlus/NikePlusHome.png";
import pic2 from "@/assets/templates/images/NikePlus/Categories.png";
import pic3 from "@/assets/templates/images/NikePlus/mp.png";
export const NikePlusTemplate = () => {
  return (
    <section>
        ...
        <div class="sm:pt-2 md:pr-6 lg:relative lg:ml-auto lg:w-[19.5rem] lg:flex-none lg:pl-8 lg:pr-0">
          <div class="flex items-center gap-2">
            <h2 class="text-base font-semibold text-slate-900">
              <a href="https://nike-plus.vercel.app/">
                <span class="absolute inset-0 lg:left-8"></span>Nike Plus
              </a>
            </h2>
          </div>
          <p class="text-sm capitalize leading-6 text-slate-600">
            Sneaker Store Template
          </p>
          ...
          <a
            href="https://github.com/jpeseWang/tailwind-template/raw/main/src/assets/templates/nike-plus-main.zip"
            download
        ...
        <div className="lg:relative lg:mr-auto lg:flex lg:min-w-0 lg:overflow-x-auto">
          ...
          <div className="lg:relative lg:flex lg:flex-none lg:items-start lg:pr-8">
            <a
              ...
              href="https://nike-plus.vercel.app/"
            >
              <span class="sr-only">View Commit template</span>
            </a>
            <Image
              src={pic1}
