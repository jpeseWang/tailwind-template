...
import Marketing from "@/components/components-ui/marketing/Marketing";
const Components = () => {
  return (
    <>
      <Head>
      ...
      <div className="sticky top-0 overflow-x-auto whitespace-nowrap border-b border-t transition duration-100  z-40 border-slate-900/5 bg-transparent">
