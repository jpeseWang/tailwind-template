...
const tiers = [
  {
    ...
    href: "/payment/plus",
    priceMonthly: "$3",
    description: "A plan that scales with your rapidly growing layout design.",
    features: [
      "60+ components",
      "Up to 600+ templates",
      "Monthly payments",
...
export default function Pricing() {
  ...
  const handleNavCode = () => {
    if (session) {
      router.push(`/auth/setting/${session.data.id}#promotion`);
    }
  };
  return (
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
              ...
              <div className="flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl p-8 ring-1 ring-gray-900/10 sm:gap-y-10 sm:p-10 lg:col-span-2 lg:flex-row lg:items-center">
                ...
                >
                  Enter Promotion Code <span aria-hidden="true">&rarr;</span>
                </button>
              </div>
            </div>
          </div>
